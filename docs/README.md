...
| 11 | [Penetration Testing](./11-penetration-testing.md) | Penetration testing methodology, findings, and remediation |
| 12 | [User Guide](./12-user-guide.md) | End-user guide for running experiments, viewing results, and using the dashboard |
...
- **11** — Penetration testing methodology, findings, and remediation
...
- **12** — User guide for the web dashboard (experiments, templates, clusters, reports)
...
| **Kubernetes Validation** | End-to-end validation of experiment execution pipeline against real clusters |
...
|------|-------------------|
| **End User** | [User Guide (12)](./12-user-guide.md), [FAQ in User Guide](./12-user-guide.md#11-faq) |
| **Operator** | [User Guide (12)](./12-user-guide.md), [Administrator Guide (13)](./13-administrator-guide.md), [Troubleshooting (15)](./15-troubleshooting-guide.md) |
...
| **Security Reviewer** | [Security Considerations (07)](./07-security-considerations.md), [Penetration Testing (11)](./11-penetration-testing.md) |
